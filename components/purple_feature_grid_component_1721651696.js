...
Vue.component("purple_feature_grid_component_1721651696", {
    template: `
    <!-- Features list -->
    <div id="features-grid" class="grid md:grid-cols-3 gap-8 md:gap-12 bg-white p-5">
        ...
        <div id="feature-1">
            ...
            <div class="flex" id="feature-1-description-container"><p id="feature-1-description" class="flex-1 text-sm">Stay ahead of the curve with our powerful analytics engine that processes new blockchain data in real-time, giving you instant insights into emerging trends and activities.</p></div>
        </div>
        <!-- Feature -->
        <div id="feature-2">
            ...
            <div class="flex" id="feature-2-description-container"><p id="feature-2-description" class="flex-1 text-sm">Our sophisticated parsing algorithms extract and structure complex blockchain data, making it easy to analyze and interpret even the most intricate on-chain activities.</p></div>
        </div>
        <!-- Feature -->
        <div id="feature-3">
            ...
            <div class="flex" id="feature-3-description-container"><p id="feature-3-description" class="flex-1 text-sm">Set up custom alerts to notify you instantly when specific conditions or events occur on the blockchain, ensuring you never miss critical developments.</p></div>
        </div>
        <!-- Feature -->
        <div id="feature-4">
            <div id="feature-4-header" class="flex items-center space-x-2 mb-1">
                ...
                <div class="flex" id="feature-4-title-container"><h4 id="feature-4-title" class="flex-1 text-slate-50 font-medium">Insightful Visualizations</h4></div>
            </div>
            <div class="flex" id="feature-4-description-container"><p id="feature-4-description" class="flex-1 text-sm">Gain a deeper understanding of blockchain dynamics through our interactive visualizations, which present complex data in clear, intuitive formats.</p></div>
        </div>
        <!-- Feature -->
        <div id="feature-5">
            ...
            <div class="flex" id="feature-5-description-container"><p id="feature-5-description" class="flex-1 text-sm">Easily integrate our analysis tools into your existing workflows and systems, enabling you to leverage blockchain insights across your entire technology stack.</p></div>
        </div>
        <!-- Feature -->
        <div id="feature-6">
            <div id="feature-6-header" class="flex items-center space-x-2 mb-1">
                ...
                <div class="flex" id="feature-6-title-container"><h4 id="feature-6-title" class="flex-1 text-slate-50 font-medium">Scalable Architecture</h4></div>
            </div>
            <div class="flex" id="feature-6-description-container"><p id="feature-6-description" class="flex-1 text-sm">Our highly scalable architecture can handle massive volumes of blockchain data, ensuring you can analyze even the busiest networks with ease.</p></div>
        </div>
    </div>`,
        data() {
            return {
