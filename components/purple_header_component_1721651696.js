...
Vue.component("purple_header_component_1721651696", {
    template: `
    <div class="flex">
        <aside class="w-64 h-screen bg-slate-800">
            <nav class="p-4">
                <ul>
                    <li><a href="#" class="block py-2 px-4 text-slate-300 hover:text-white">Home</a></li>
                    <li><a href="#" class="block py-2 px-4 text-slate-300 hover:text-white">About</a></li>
                    <li><a href="#" class="block py-2 px-4 text-slate-300 hover:text-white">Contact</a></li>
                </ul>
            </nav>
        </aside>
        <div class="flex-1">
                    ...
                    <div class="flex items-center justify-between h-16 md:h-20">
                        ...
                        <nav id="desktop-navigation" class="hidden md:flex md:grow">
                            ...
                            <ul id="desktop-menu-links" class="flex grow justify-center flex-wrap items-center">
                                ...
                                <li><a id="New Data Analysis-link" class="font-medium text-sm mx-4 lg:mx-5 transition duration-150 ease-in-out text-slate-300 hover:text-white" href="New Data Analysis.html">New Data Analysis</a></li>
                            </ul>
                        ...
                        <div id="mobile-menu" class="md:hidden flex items-center ml-4" x-data="{ expanded: false }">
                            ...
                            <nav id="mobile-nav" class="absolute top-full z-20 left-0 w-full px-4 sm:px-6 overflow-hidden transition-all duration-300 ease-in-out" x-ref="mobileNav" :style="expanded ? 'max-height: ' + $refs.mobileNav.scrollHeight + 'px; opacity: 1' : 'max-height: 0; opacity: .8'" @click.outside="expanded = false" @keydown.escape.window="expanded = false" x-cloak>
                                <ul id="mobile-nav-list" class="border border-transparent rounded-lg px-4 py-1.5 bg-gradient-to-r from-slate-800 to-slate-800 bg-origin-border">
                                    ...
                                    <li><a id="mobile-New Data Analysis-link" class="flex font-medium text-sm py-1.5 text-slate-300 hover:text-white" href="New Data Analysis.html">New Data Analysis</a></li>
                                </ul>
                            </nav>
